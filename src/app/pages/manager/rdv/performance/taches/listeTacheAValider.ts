...
@Component({
    selector: 'app-liste-tache-a-valider',
    standalone: true,
    imports: [
        TableModule,
        MultiSelectModule,
    ...
    templateUrl: "./listeTacheAValider.html",
    styleUrl: "./listeTacheAValider.css",
    providers: [ConfirmationService, MessageService, CustomerService, ProductService]
})
export class ListeTacheAValider implements OnInit {
    customers1: Customer[] = [];
    ...
    validerTravail(tache: any) {
        this.RDVService.validerPlanning(
    ...
    loadData(event: any | null = null): void {
        ...
        this.listPlanning = [];
        this.RDVService.getPlanningOfMecanicienAValider(page, this.idMecanicien).subscribe(data => {
            this.listPlanning = data.planning;
    ...
    ngOnInit() {
        this.idMecanicien=this.route.snapshot.paramMap.get('idMecanicien');
        this.loadData();
    }
